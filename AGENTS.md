...
- `backend/app/models.py` defines the 16-table relational model. `DocumentChunk.course_id` and `DocumentPage.course_id` are intentional denormalization for course-scoped reads.
...
- Alembic is the only runtime schema-management mechanism. The canonical chain is `97d9fd86a3ba -> b6d8f2a4c901 -> d2a7f0c91e35 -> c4e6a8f1b203 -> f7a3c9d2e541 -> a8c4e2f7b913 -> a4fd52f56b91 -> b7e2a9d1c3f4 -> e5c1a7b39d64 -> a1c5e7f9b203 -> c9b3d5e08f27 -> d3f8b21a6c40 -> e4a7b1c90d52`; add schema changes as descendants and keep one base/head unless an explicit migration design requires otherwise.
