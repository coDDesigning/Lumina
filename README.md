...
Lumina is an open-source, student-first AI study workspace.

Development dependencies and reproducible installation commands are documented
...
AI usage and error telemetry are documented in
[`docs/ai_usage_telemetry.md`](docs/ai_usage_telemetry.md); prompt templates in
[`docs/prompt_templates.md`](docs/prompt_templates.md); PR-Agent operation in
[`docs/pr-agent.md`](docs/pr-agent.md).
