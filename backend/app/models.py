...
from sqlalchemy import DateTime, ForeignKey, String, func, Integer, Text, UniqueConstraint
...
class User(Base):
    ...
    courses: Mapped[list["Course"]] = relationship(back_populates= "owner", cascade="all, delete-orphan",passive_deletes = True)
...
class Course(Base):
    ...
    documents: Mapped[list["UploadedDocument"]] = relationship(back_populates="course",cascade="all, delete-orphan", passive_deletes= True)
