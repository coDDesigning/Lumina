...
| `exam_style_question` | `2.1.0` | active | `services/exam_similar_questions.py` | Fresh attemptable questions in the observed style of the course's own past ones | `GeneratedSimilarQuestionResponse` |
...
| `exam_topic_practice` | `1.1.0` | active | `services/exam_quiz.py` | Exam Mode per-topic practice questions | `QuizGenerationResponse` |
| `exam_topic_exam` | `1.1.0` | active | `services/exam_quiz.py` | Exam Mode per-topic examination | `QuizGenerationResponse` |
| `exam_mock_exam` | `2.1.0` | active | `services/exam_course_artifacts.py` | Timed mock examination assembled to calculated per-topic and per-type quotas | `QuizGenerationResponse` |
...
| `model_check` | `1.0.0` | active | `services/model_check.py` | Minimal connectivity/response check for a single AI model | — |
