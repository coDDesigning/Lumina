...
const PIPELINE = [
  {
    label: 'First',
    lead: 'You upload.',
    body: 'PDF, text, Markdown, or an image. Drop in ten files at once if you like.',
  },
  {
    label: 'Then',
    lead: 'Lumina reads.',
...
const CAPABILITIES = [
  {
    ...
    body: 'PDF, TXT, Markdown, and images (PNG, JPEG). Scanned pages and photos go through OCR automatically. Duplicates are caught by content, not filename.',
  },
  {
    title: 'Study guides',
