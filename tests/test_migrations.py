...
BYOK_ENCRYPTED_KEYS_REVISION = "2ecde7624a99"
GENERATION_JOBS_REVISION = "ebccfdeadee4"
FLASHCARD_GENERATION_JOBS_REVISION = "9f4c1d7b2e83"
EMBEDDING_WIDTH_REVISION = "a1f6c3b7d284"
...
def test_migration_graph_has_one_canonical_base_and_head() -> None:
    ...
    assert revisions == {
        POLICY_ACKNOWLEDGEMENTS_REVISION: DESCRIBE_VISUALS_JOBS_REVISION,
        ...
        EMBEDDING_WIDTH_REVISION: FLASHCARD_GENERATION_JOBS_REVISION,
        FLASHCARD_GENERATION_JOBS_REVISION: GENERATION_JOBS_REVISION,
        GENERATION_JOBS_REVISION: BYOK_ENCRYPTED_KEYS_REVISION,
        BYOK_ENCRYPTED_KEYS_REVISION: PROFILE_SCHEMA_ALIGNMENT_REVISION,
